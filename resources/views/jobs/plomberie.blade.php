  ...
  <div class="container alt section-space">
    <div class="row c-how__heading align-row">
      <div class="col-xs-12 col-sm-6 c-how__headingLeft">
        ...
        <h1 class="h2 u-bold">Besoin d'un plombier ?</h1>
        <p class="u-margin-t-md subHeading">La plomberie vient du terme "plomb" qui caractérisait les tuyaux d'eau des installations sanitaires. La plomberie désigne l'ensemble des techniques utilisées pour faire circuler un ensemble de fluides tel l'eau ou les gaz dans les différents endroits d'une installation. Nous vous envoyons les meilleurs qui règleront vos problèmes, vite fait bien fait</p>
      ...
      <div class="col-xs-12 col-sm-6 c-how__headingRight">
        <img src="https://previews.123rf.com/images/andreypopov/andreypopov1507/andreypopov150700337/42193224-jeune-africaine-homme-plombier-fixation-%C3%A9vier-avec-outil-de-travail-dans-la-cuisine.jpg" />
      </div>
    </div>
  </div>
  <div class="container alt section-space">
